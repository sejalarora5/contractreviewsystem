        ...
        <>
            <nav className="bg-white shadow-md text-white flex flex-wrap items-center justify-between p-4 mb-4 relative">
                ...
                <div className={`${isMenuOpen ? 'flex' : 'hidden'
                    ...
                    <Link
                        to="/"
                        className={`btn btn-ghost text-lg normal-case mb-2 md:mb-0 ${location.pathname === '/' ? 'text-[#f49535]' : 'text-black'
                            }`}
                    ...
                    <Link
                        to="/explanation"
                        className={`btn btn-ghost text-lg normal-case mb-2 md:mb-0 ${location.pathname === '/explanation' ? 'text-[#f49535]' : 'text-black'
                            }`}
                        onClick={() => setIsMenuOpen(false)}
                    >
                        Explanation
